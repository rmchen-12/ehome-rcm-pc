  ...
  _createClass(DynamicForm, [{
    ...
    value: function render() {
      ...
      return _react["default"].createElement("div", {
        ...
        return _react["default"].createElement("div", {
          key: rule.key
        }, children(rule, dataBind), !rule.disableBtn && index > 0 && _react["default"].createElement(_antd.Button, {
          style: {
            marginLeft: 10
          },
          type: "primary",
        ...
        }), !rule.disableBtn && index === 0 && _react["default"].createElement(_antd.Button, {
          style: {
            marginLeft: 10
          },
          ...
          shape: "circle",
          icon: "plus"
        }), !rule.disableBtn && canMove && index > 0 && _react["default"].createElement(_antd.Button, {
          style: {
            marginLeft: 10
          },
          ...
          shape: "circle",
          icon: "up"
        }), !rule.disableBtn && canMove && index < length && _react["default"].createElement(_antd.Button, {
          style: {
            marginLeft: 10
          },
